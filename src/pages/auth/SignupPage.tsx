        ...
        <div className="hidden lg:flex flex-col justify-between p-12 gradient-hero relative overflow-hidden group order-2 lg:order-1">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl xl:text-5xl font-extrabold text-white leading-[1.1] mb-8">
              Build your future{" "}
              <span className="text-white/70">with SkillBridge.</span>
            </h2>
            <div className="space-y-6">
              {[
                {
                  title: "Smart Scoping",
                  desc: "AI tools to define your project perfectly",
                },
                {
                  title: "Early Bird Benefits",
                  desc: "Join early to get exclusive platform benefits",
                },
                {
                  title: "Transparency",
                  desc: "Clear workflows and secure interactions",
                },
              ].map((item, i) => (
                <div
                  key={i}
            ...
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full border-2 border-primary bg-muted/20 flex items-center justify-center text-[10px] text-muted-foreground overflow-hidden"
                  >
                    <img
              ...
              <p className="text-white/60 text-xs">
                Be part of the next generation of freelancers.
              </p>
            </div>
          </div>
        </div>
