...
const MOCK_REVIEWS: ReviewWithDetails[] = [
  {
    ...
    rating: 5,
    comment:
      "Alex did an exceptional job on the React Native conversion. His communication was top-notch, and he delivered ahead of schedule. Highly recommended!",
    isBlind: false,
  ...
  },
  {
    ...
    rating: 4,
    comment:
      "Sarah is a great designer. The UI concepts were modern and user-friendly. There were a few minor delays, but the quality of work made up for it.",
    isBlind: false,
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Perfect execution on the backend API. The code is clean, well-documented, and scalable. Will definitely hire again.",
    isBlind: false,
            ...
            <Card key={review.id} className="transition-all hover:shadow-md">
              <CardHeader className="flex flex-row items-start gap-4 pb-2">
                <Avatar className="h-12 w-12 border">
                  ...
                  <AvatarFallback>
                    {review.developer.name.charAt(0)}
                  </AvatarFallback>
                </Avatar>
