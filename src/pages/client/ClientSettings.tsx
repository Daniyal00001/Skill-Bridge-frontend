      ...
      <div className="container max-w-5xl mx-auto p-4 md:p-8 space-y-8 animate-fade-in">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
              ...
              <div className="space-y-6">
                <Card className="border-border/40 bg-card/50 backdrop-blur-sm shadow-xl">
                  <CardHeader className="bg-primary/5 border-b border-primary/10">
                    ...
                    <CardDescription>
                      This information will be visible to other members on the
                      platform.
                    </CardDescription>
                  </CardHeader>
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div className="space-y-2 text-center sm:text-left text-balance">
                          ...
                          <p className="text-sm text-muted-foreground max-w-xs">
                            Use a professional photo to build trust with
                      ...
                      <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="space-y-2 md:col-span-2 text-left">
                          ...
                          <p className="text-[10px] text-muted-foreground italic mt-1">
                            Direct contact email for platform notifications.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <TabsContent
            ...
            className="animate-in fade-in-50 duration-500"
          >
            <Card className="border-border/40 bg-card/50 backdrop-blur-sm shadow-xl max-w-3xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                ...
                <CardDescription>
                  Track your latest actions, project posts, and interactions.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  {[
                    {
                      action: "Posted a new project 'Mobile App Redesign'",
                      time: "2 days ago",
                      icon: Briefcase,
                    },
                    {
                      action: "Hired Daniyal for 'E-commerce SEO'",
                      time: "1 week ago",
                      icon: User,
                    },
                    {
                      action: "Approved milestone for 'Logo Branding'",
                      time: "2 weeks ago",
                      icon: CheckCircle2,
                    },
                    {
                      action: "Received a 5-star review from Alex",
                      time: "3 weeks ago",
                      icon: Star,
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-4 p-4 rounded-xl border border-border/40 bg-muted/20 hover:bg-muted/30 transition-colors group"
                    >
